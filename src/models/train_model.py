...
def main(args):
    ...
    if args.architecture == 'MIMO_UNet_Beamforming':
...
if __name__ == '__main__':
    ...
    #saving parameters
    parser.add_argument('--results_path', type=str, default='RESULTS/Task1_v2',
                        help='Folder to write results dicts into')
    parser.add_argument('--checkpoint_dir', type=str, default='RESULTS/Task1_v2',
